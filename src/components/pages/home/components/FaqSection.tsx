...
export const FaqSection = () => {
  ...
  return (
    <section className="bg-[#141414] py-[410px] px-6 text-white">
      <div className="container mx-auto max-w-[1240px]">
        
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="font-['Orbitron'] text-3xl md:text-[45px] font-bold leading-tight uppercase">
          ...
          {faqs.map((faq, index) => (
            <div 
              ...
              className={`border border-[#FFC700]/30 transition-all duration-300 ${
                openIndex === index ? 'bg-[#1A1A1A] border-none' : 'bg-transparent'
              }`}
            >
              <button 
